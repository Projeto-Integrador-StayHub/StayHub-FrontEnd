...
import style from "../../app/telaPerfilDono/page.module.scss";
...
export default function TelaPerfilDono() {
  ...
  const fetchUserData = async () => {
    try {
      const idDono = "id_do_dono"; 
      const response = await fetch(`https://localhost:7274/api/DonoHotel/EditarDono/${idDono}`);
    ...
    <div className={style.pageWrapper}>
      ...
      <div className={style.container}>
        <div className={style.rightColumn}>
          {["Nome", "E-mail", "Senha", "Telefone", "CPF", "Data de Nascimento", "Endereço"].map((label, index) => (
            <div className={style.formGroup} key={index}>
              ...
              <div className={style.inputContainer}>
                <input
                  ...
                  value={userData ? userData[label.toLowerCase().replace(/ /g, "")] : ""}
                  onChange={(e) =>
                    setUserData({
                      ...userData,
